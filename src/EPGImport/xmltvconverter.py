    ...
    try:
        for event, elem in iterparse(fp):
            try:
                ...
                print("[XMLTVConverter] enumerateProgrammes error: " + str(e))
    except LZMAError as e:
        print("[XMLTVConverter] LZMA decompression failed: " + str(e))
        print("[XMLTVConverter] File is corrupted or uses unsupported compression")
        # Exit gracefully instead of crashing
        return
    except Exception as e:
        print("[XMLTVConverter] General parsing error: " + str(e))
        return
